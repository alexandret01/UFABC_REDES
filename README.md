...
> **Dataset de alarmes:** o `PadtecAlarmConsumer` gera e exporta o CSV de alarmes diretamente pela interface do ONOS (`/onos/v1/alarms`). Use esse export como dataset principal de alarmes — o runner não duplica essa coleta.
